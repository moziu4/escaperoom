...
import { empezamos } from "../../../store/empezar/reducer"
import { acabado } from "../../../store/salas/reducer"
...
const importHechos = (state) => {
  return {
    respuesta: acabado(state),
    comienzo: empezamos(state),
  }
}

const Fondo = ({respuesta,comienzo}) => {
  return (
...
export default connect(importHechos,null)(Fondo)
